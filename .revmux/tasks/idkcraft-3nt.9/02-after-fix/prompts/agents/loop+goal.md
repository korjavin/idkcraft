...
- `/Users/iv/Projects/idkcraft/.revmux/tasks/idkcraft-3nt.9/02-after-fix/input/scope.md` — what is under review and the command that produces the diff. Read this first and run
  that command yourself.
- `/Users/iv/Projects/idkcraft/.revmux/tasks/idkcraft-3nt.9/02-after-fix/input/goal.md` — the bead this change delivers and its acceptance criteria.
- `/Users/iv/Projects/idkcraft/.revmux/tasks/idkcraft-3nt.9/02-after-fix/prompts/input-profile.md` — the project's own conventions. Where they disagree with your taste, they win.
- `/Users/iv/Projects/idkcraft/.revmux/tasks/idkcraft-3nt.9/02-after-fix/input/context` — supporting material: bead text, design notes.
...
Judge the change against the bead in `/Users/iv/Projects/idkcraft/.revmux/tasks/idkcraft-3nt.9/02-after-fix/input/goal.md` and `/Users/iv/Projects/idkcraft/.revmux/tasks/idkcraft-3nt.9/02-after-fix/input/context`, not against a better change you
