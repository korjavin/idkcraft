# Review: idkcraft-3nt.8 / 02-after-fix

scope: `/Users/iv/Projects/idkcraft/.revmux/tasks/idkcraft-3nt.8/02-after-fix/input/scope.md`

## Minor

### 'stop' said during the brain await still issues one follow goal

`bot/src/index.js:116`
...
_confidence: 80 | sources: loop+goal | lenses: bot-loop, goal-and-tests | verdict: confirmed_

### 'parked with nobody online scans nothing' passes by construction — the scout throttle, not the guard, makes it green

`bot/test/tick.test.js:296-313`
...
| --- | --- | --- | --- | --- | --- | --- |
| loop+goal | claude | claude-opus-5 (requested opus) | high | 668914 | 2 | ok |
| contract | claude | claude-opus-5 (requested opus) | high | 313631 | 0 | ok, nothing raised |
